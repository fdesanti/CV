...
\cvitem{}{\emph{\vspace{-1cm}\\
$\quad$ PhD student in Physics and Astronomy at the University of Milano-Bicocca focusing on Gravitational Waves Astrophysics and Data Analysis. Research interests include eccentric compact binaries, Bayesian Statistics and (Probabilistic) Machine Learning applied to Simulation Based Inference (SBI).}}
...
\vspace{-0.1cm}
\begin{tabular}{rcl}
&\hspace{0.4cm} &$\circ\;\;${\textbf{\textit{Supervisors}}}: Prof. D. Gerosa \& Prof. Bruno Giacomazzo.
\\
\end{tabular}
