...
&\hspace{0.4cm} &$\circ\;\;${\textbf{\textit{Thesis}}}: \textit{Gravitational Waves from Binary Close Encounters: Fast Parameter Estimation with Normalizing Flows}.\\
...
\vspace{-0.1cm}
\begin{tabular}{rcl}
&\hspace{0.4cm} &$\circ\;\;${\textbf{\textit{Project title}}}: \textit{Machine Learning methods for the detection of gravitational wave signals
produced by close encounters between compact objects in binary systems}.\\
\end{tabular}
\vspace{0.2cm}
