...
\newcommand{\orcid}[1]{%
  \href{https://orcid.org/#1}{\includegraphics[height=9pt, keepaspectratio]{ORCID_LOGO.png}\, \small #1}%
}
\newcommand{\github}[1]{%
  \href{https://github.com/#1}{\includegraphics[height=9pt, keepaspectratio]{github-logo.png}\, #1}%
}
...
\extrainfo{\centering \normalsize PhD student $\;\;\bullet\;\;$\orcid{0009-0000-2445-5729} $\;\;\bullet\;\;$ \github{fdesanti} $\;\;\bullet\;\;$ \today}