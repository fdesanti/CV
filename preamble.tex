...
\newcommand{\orcid}[1]{%
  \href{https://orcid.org/#1}{\includegraphics[height=11pt]{ORCID-iD_icon_32x32.png}\, #1}%
}

\firstname{Federico}
\familyname{De Santi}

\extrainfo{\normalsize f.desanti@campus.unimib.it $\;\;\bullet\;\;$\orcid{0009-0000-2445-5729} $\;\;\bullet\;\;$ \today}