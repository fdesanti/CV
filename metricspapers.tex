...
\textbf{3} papers published in major peer-reviewed journals,
\\ & &
\textbf{2} other publications (white papers, long-authorlist reviews, proceedings, software, etc)
\\ & &
(out of which \textbf{2} first-authored papers
).
\end{tabular} }\medskip
Summary metrics reported using ADS and InSpire excluding [including] long-authorlist papers:
\\\medskip
\textcolor{mark_color}{\textbf{Total number of citations}}: 223 [461].
 --- 
\textcolor{mark_color}{\textbf{h-index}}: 3 [3].
\\\medskip
